...
@Component
public class DividerStrategyImpl implements InitializingBean, FormStrategy {
    @Override
    public void afterPropertiesSet() throws Exception {
        afterPropertiesSet(FormTypeEnum.DIVIDER.getType());
    }
...
//
//        boolean date = com.sentury.approvalflow.common.utils.DateUtil.isDate(dateVal);
